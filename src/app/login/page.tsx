  ...
  const handleLoginSuccess = async (userCredential: UserCredential) => {
    ...
    if (isNewUser) {
        ...
        await setDoc(userDocRef, newUserProfile);
         // Log activity
        await logUserActivity(user.uid, 'signup', { method: userCredential.providerId || 'social' }, deviceInfo);
    } else {
        await logUserActivity(user.uid, 'login', { method: userCredential.providerId || 'email' }, deviceInfo);
    }
